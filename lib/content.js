const BASE_PATH = "/Father-s-Day"; // Set to "/Father-s-Day" for GitHub Pages, or "" for Vercel/Custom Domain
...
(Make sure to edit this letter in 'lib/content.js' with your own personal words before sharing it with him!)`,
  ...
  // ── HIDDEN MESSAGE ────────────────────────────────────
  hiddenMessage: "I love you, Dad. Thanks for always being the best hero to ever be there.",
}
